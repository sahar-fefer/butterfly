  ...
  const donatedList = [
    {
      ...
      about:
        "רשת חנויות ריהוט לבית מלווים את הבית של עומר משלב הקמתו. עזרו לנו להפוך קירות לבית. ספות וכורסאות רכות ומפנקות, שולחן אוכל גדול, כסאות נוחים וצבעוניים, שולחן עבודה ובעיקר לא שמענו מהם אף פעם שאי אפשר. תמיד מוצאים את הדרך לומר כן.",
    },
    {
      imgName: Riviera,
      imgShape: "square",
      ...
      about:
        "מה היינו עושות בלעדיכם? הבגדים של בנות הבית (ויש לנו לא מעט...) מסודרים בארונות קיר לבנים, מרווחים שנבנו לנו ברביירה במיוחד לפי מידה. הובלתם והרכבתם לנו ארון בכ",
      about2:
        "ל חדר וחדר כשהקמנו את הבית וגם כשעברנו לבית חדש, תמיד בחיוך ובשמחה",
      short: true,
    },
    {
      imgName: Polyron,
      ...
      about:
        "בזכותם כל בנות הבית ישנות טוב בלילה על מיטות ומזרנים משובחים של פולירון. גם את הבוגרות שלנו שיוצאות לחיים עצמאיים, פולירון יודעים לפנק ברוחב לב. תמיד שם. מחכים שנבקש.",
    },
    {
      imgName: Avatar,
      imgShape: "circle",
      ...
      about2:
        " היטב, לצמחי תבלין, שותל, מטפח, מרחיק עשבים ועושה את הגינה ואותנו שמחות.",
      short: true,
    },
    {
      imgName: Avatar,
    ...
    },
    {
      ...
      name: "אפרת כהן",
      about:
        'אנחנו אוהבות לקרוא לה "המפקדת" 😊 אפרת אחראית, מרימה, מפיקה ומתכללת את כל ארוע המכירה השנתי "מתלבשות על הבית של עומר", מרחפת כמו פייה לפני, בארוע ואחרי, במגע של קסם וחיוך פתאום הכל קורה ומסתדר, לא מובן מאליו החיבור שלה לבית, היכולות המדהימות והנתינה הבלתי סופית. ובין מכ',
      about2:
        "ירה למכירה היא תמיד איתנו לכל מה שנדרש. מלווה צעירות אשר מסיימות את שהותן בבית, דואגת שהמעבר יעבור בקלות ולכל מה שזקוקות בבית החדש, מנטורית לחיים עבורן, וגם עבורינו.",
      short: true,
    },
    {
      imgName: Avatar,
      ...
      name: "יפית סלע",
      about:
        "ליפית יש בוטיק בגדים מהמם בהוד השרון, פעמיים בשנה היא מסמסת בשקט וצנעה ורק שואלת: כמה בנות בבית? לפי מספר הבנות, היא מכינה לכל אחת מהן שקית מפנקת של פרטי לבוש חדשים ישר מהחנות, שקית מלאה בטוב, נדיבות וחיוך ענק.",
    },
  ];
  ...
  return (
    <Layout>
      <div className="donate-page">
        ...
        <LargeBanner
          bgImage={takeAPart}
          bgImageAlt={"בואו לקחת חלק ולהתנדב בבית של עומר"}
          title={"רוצים לקחת חלק?"}
          text={
