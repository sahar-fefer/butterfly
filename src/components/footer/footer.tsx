      ...
      <div className={s.wrapper}>
        <div className={s.groupWrapper}>
          <div className={s.group}>
            ...
            <Link to="/omers-house" onClick={resetNav}>
              הבית של עומר
            </Link>
            <Link to="/omers-butterflies" onClick={resetNav}>
              הפרפרים של עומר
            </Link>
            <Link to="/bracelets" onClick={resetNav}>
              צמידים
            </Link>
          </div>
          <div className={s.group}>
            ...
            <a href="mailto:omer.butterflies@gmail.com">
              omer.butterflies@gmail.com
            </a>
          </div>
          <div className={s.group}>
            <div className={s.title}>מידע</div>
            <Link to="/about" onClick={resetNav}>
              אודות
            </Link>
            <a
              href="https://www.websiteplanet.com/he/blog/%D7%94%D7%AA%D7%90%D7%99%D7%9E%D7%95-%D7%90%D7%AA-%D7%9E%D7%93%D7%99%D7%A0%D7%99%D7%95%D7%AA-%D7%94%D7%A4%D7%A8%D7%98%D7%99%D7%95%D7%AA-%D7%A9%D7%9C%D7%9B%D7%9D-%D7%9C-gdpr/"
              target="_blank"
            >
              מדיניות פרטיות
            </a>
          ...
          <div className={s.group}>
            ...
            <a
              href="https://www.facebook.com/%D7%94%D7%91%D7%99%D7%AA-%D7%A9%D7%9C-%D7%A2%D7%95%D7%9E%D7%A8-152744878915859"
              target="_blank"
            >
              הבית של עומר
              <svg
            ...
            <a
              href="https://api.whatsapp.com/send?phone=972544404322&data=AWDSJ3-3Mwj5cd5zk7J3wFNtdCd0wocfne9KgkWrNHWH_XUpGJgxpCofG_v1J1rXRZe8Wpc3EN7Vy3vAMsOaRr0ReLJYZJwdTAIrtJLUAZnlEylPxpBUX5wwnrkFO-ymev_QKmyC6fiyiJ-VLZ73DjwAhUcI3p1Fib4_F9tFlBFDETFHKXs7zOePU5K3qTyOdCZNCPlSp0nMa7-_rUnaRVQwgEep9MoTWF86jEo2Sq-T_xNx4WiEGJHV0CFGwMBSUxNfAyuWMjVC0FU1tQU&source=FB_Page&app=facebook&entry_point=page_cta&fbclid=IwAR0x-TdaPUcIBvMMIhUG_8wcnJh1jZfUC1Al6OSBwr3oIspRBj54LhA32NE"
              target="_blank"
            >
              WhatsApp
              <svg
        ...
        <div className={s.protects}>
          © 2022 - כל הזכויות שמורות לבית של עומר,
          <br /> אין לעשות שימוש בחומר המופיע בדף זה ללא אישור מפורש
        </div>
      </div>
    </footer>
  );
