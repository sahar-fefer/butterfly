    ...
    return (
        <form className='form' onSubmit={handleSubmit}>
            <div className='dropdown' ref={ref}>
                <button type="button" className='dropdown-button' onClick={(e: React.MouseEvent<HTMLElement>) => toggleButton(e as any)}>
                    {dropdownTitle}
            ...
            {
                errors.formContent &&
                <span className="err">- {errors.formContent}</span>
            }
            <button className='submit'
                type="submit">
                <div className="text">שליחת טופס</div>
                <div className="loader"></div>
                <svg className='send' width="100%" height="100%" fill="none" stroke="#FFFFFF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="16px" strokeDashoffset="16px" viewBox="0 0 14 11">
