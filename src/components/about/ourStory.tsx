...
function OurStory() {
    ...
    return (
        <section className='our-story'>
            <h2>הסיפור שלנו</h2>
            <p>עומר , כמעט בת 21, נסעה אחרי הצבא לטיול הגדול, עם תרמיל על הגב, עם הרבה חלומות ותמימות שהכל אפשרי. לפני כשנתיים, בדרך לטרק בנפאל, האוטובוס בה נסעה התגלגל לתהום ועומר נהרגה במקום. אנחנו, המשפחה של עומר והחברים הקמנו להנצחתה את עמותת "הפרפרים של עומר.</p>
